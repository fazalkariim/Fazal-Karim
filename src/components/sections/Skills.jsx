...
function SkillCard({ skill }) {
  ...
  return (
    <div className="group relative min-w-[170px] p-5 border border-border bg-card hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-elevated">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />

      <div className="relative">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-primary/10 border border-primary/20 grid place-items-center shrink-0">
            <img
              src={skill.icon}
              alt={skill.name}
  ...
  animation: skillsMarqueeReverse 60s linear infinite;
      ...
      <div className="w-full max-w-[1680px] mx-auto px-6 lg:px-12 xl:px-12 2xl:px-20">
        <SectionHeader
          ...
          description="The tools I reach for — chosen for performance, maintainability, and speed."
        />
